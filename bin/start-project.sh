#!/bin/bash
# Creates a project folder for the board and opens Claude Code in it.
# Usage: start-project.sh /dev/ttyACM0
#
...
exec env PYTHONPATH="$PLUGIN_DIR/mcp" "$PYTHON3" -B -s -m omarchy_hardware.project "$1"
